...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>TheBasicDAO</title>
        <meta name="description" content="The Basic DAO" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to THe Basic DAO!</h1>
          <div className={styles.description}>
            Your Balance of anNFTs: {nftBalance}
            <br />
